...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/newname58q/radiombot)

NOTE: Make sure you have started a VoiceChat in your Group before deploying.
### Deploy to VPS

```sh
git clone https://github.com/newname58q/radiombot
cd MusicPlayer
...
Connect Me On [Telegram](https://telegram.dog/jackmedya)

## Credits 
- [Dash Eclipse's](https://github.com/newname58q) for his [tgvc-userbot](https://github.com/newname58q).
